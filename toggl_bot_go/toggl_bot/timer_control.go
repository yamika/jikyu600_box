...
func (t *Toggl_manager) Start_timer(wid int) string {
...
func (t *Toggl_manager) Stop_timer(id int) string{
...
func (t *Toggl_manager) Calc_time_from_time_entries(){
  // UTCをJSTに変換
  ...
  starttime := strconv.Itoa(int(start.Hour())) + ":" + strconv.Itoa(int(stop.Minute()))
  stoptime := strconv.Itoa(int(start.Hour())) + ":" + strconv.Itoa(int(stop.Minute()))
